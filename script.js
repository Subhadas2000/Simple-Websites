...
noBtn.addEventListener("click", () => {
  ...
  while (!safe) {
    ...
    // pretend the button moved there; check for overlap
    const btnRect = {
      left: x,
  ...
  // place the button at the safe location
  ...
  yesBtn.addEventListener("click", () => {
    ...
    // Replace the GIF on screen
    const img = document.querySelector("img");
    img.src = "https://media.tenor.com/zkSMgNfy1VMAAAAM/hug-warm-hug.gif";
